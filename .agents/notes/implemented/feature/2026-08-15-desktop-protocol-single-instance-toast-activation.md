...
- Windows toast click-through works; toast identity is the shell's own AUMID (the boot-registered Start Menu shortcut), falling back to PowerShell only when registration fails.
...
Related: [desktop capability seams](../architecture/2026-08-14-desktop-capability-seams-notifications-updater.md), [shell bridge consumers](../architecture/2026-08-14-desktop-shell-bridge-consumers.md).

...
第一版支持粘贴和拖放 PNG、JPEG、WebP 与 GIF，支持仅图片或混合提示词，支持渲染历史用户图片与助手图片，并支持单击预览原图（展示与交互细节部分由[附件展示对齐 Note](2026-08-11-web-attachment-display-alignment.md)取代）。[聊天文件引入提案](../../proposed/feature/2026-08-16-chat-file-intake.md)负责文件选择和通用文本文件；PDF、音频、视频、图片复制和自定义上下文菜单仍分别作为后续工作。

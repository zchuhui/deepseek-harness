...
| [desktop.md](desktop.md) | the desktop shell integration: the `ctx.desktopHost` window/settings seam, the shell bridge, the three desktop providers, the web GUI settings rows, and the loopback-pinned Host desktop RPC methods |

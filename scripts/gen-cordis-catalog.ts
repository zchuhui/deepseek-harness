...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  FileAttachmentId: 'attachment.md',
  SaveTextFileAttachment: 'attachment.md',
  StoredTextFileAttachment: 'attachment.md',
  TextFileAttachmentLimits: 'attachment.md',
  TextFileAttachmentRef: 'attachment.md',

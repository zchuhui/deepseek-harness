...
const packageFileExtras: Readonly<Record<string, readonly string[]>> = {
  ...
  '@deepseek-ai/dsh-desktop': ['cordis.patch.yml'],
  '@deepseek-ai/dsh-workspace-notes-bundle': ['cordis.patch.yml'],
  '@deepseek-ai/dsh-workspace-todos-bundle': ['cordis.patch.yml'],

...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-settings-desktop': { kind: 'none', reason: 'Browser-side UI plugin layer; registers nothing model-facing.' },
  ...
  'packages/host/desktop': { kind: 'none', reason: 'The GUI-host desktop-shell control seam registers nothing model-facing.' },
  'packages/host/desktop-shell': { kind: 'none', reason: 'The desktop-shell provider forwards window reporting and settings to the shell bridge; it registers nothing model-facing.' },
  ...
  'packages/notify/notifications': { kind: 'none', reason: 'The notification seam carries operator notifications that never reach a model request or the session log.' },
  'packages/notify/notifications-desktop': { kind: 'none', reason: 'The desktop provider renders operator notifications through the shell bridge; it registers nothing model-facing.' },
  'packages/util/desktop-bridge': { kind: 'none', reason: 'The bridge client is host-side plumbing; it registers nothing model-facing.' },
  'packages/updater/updater-desktop': { kind: 'none', reason: 'The desktop provider reports update state to host and shell code only; it registers nothing model-facing.' },
  'packages/credentials/credentials-desktop': { kind: 'none', reason: 'The desktop provider resolves credentials at the operation boundary for host consumers; secret values never reach a model request.' },
  'packages/notify/notifications-terminal': { kind: 'none', reason: 'The terminal provider renders operator notifications to the host console; it registers nothing model-facing.' },
  'packages/notify/notifications-windows': { kind: 'none', reason: 'The toast provider renders operator notifications through the OS; it registers nothing model-facing.' },
  'packages/notify/notify-events': { kind: 'none', reason: 'The bridge derives notifications from facts the emitting packages already log; it registers nothing model-facing.' },
  'packages/updater/updater': { kind: 'none', reason: 'The update seam reports state to host and provider code only; it registers nothing model-facing.' },
  'packages/updater/updater-manual': { kind: 'none', reason: 'The no-op provider reports update state to host code only; it registers nothing model-facing.' },

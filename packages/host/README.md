...
| [`desktop/`](desktop/README.md) | Desktop-shell host control seam (window reporting + shell settings) | `ctx.desktopHost` |
| [`desktop-shell/`](desktop-shell/README.md) | Desktop-shell bridge provider | registers `ctx.desktopHost` |

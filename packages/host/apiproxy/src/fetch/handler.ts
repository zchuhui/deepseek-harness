...
import {
  ...
  hostListDirectoryRequestSchema, hostOpenPathRequestSchema, hostReadDirectoryFileRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'host.readDirectoryFile': { schema: hostReadDirectoryFileRequestSchema, invoke: (api, r, signal) => api.host.readDirectoryFile(r, signal) },

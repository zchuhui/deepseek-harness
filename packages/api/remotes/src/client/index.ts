...
import workspaceNotesRemote from '@deepseek-ai/dsh-workspace-notes/remote'
import workspaceTodosRemote from '@deepseek-ai/dsh-workspace-todos/remote'
...
export type {} from '@deepseek-ai/dsh-workspace-notes/remote'
...
export type {} from '@deepseek-ai/dsh-workspace-notes/types'
export type {} from '@deepseek-ai/dsh-workspace-todos/types'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      workspaceNotesRemote, workspaceTodosRemote,
    ]) {

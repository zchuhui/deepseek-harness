...
export const zh = {
  ...
  'file.chooseDirectory': '选择文件或文件夹',
  'file.directoryHint': '逐层展开项目目录：文件会附加内容，文件夹只提供路径。',
  'file.directoryClose': '关闭目录选择',
  'file.directorySelected': '已选择 {count} 项',
  'file.directoryCancel': '取消',
  'file.directoryAdd': '添加所选内容',
  'file.directoryLoading': '正在添加…',
  'file.attachedGroup': '已附加文件',
  'file.unnamed': '未命名文件',
  'file.unsupportedType': '仅支持图片、TXT、Markdown、JSON 和 YAML 文件',
  'file.unsupportedFile': '不支持的类型',
  'file.contextFile': '文件',
  'file.contextFolder': '文件夹',
  'file.removeFolder': '移除文件夹 {name}',
...
export const en = {
  ...
  'file.chooseDirectory': 'Choose files or folders',
  'file.directoryHint': 'Expand the project tree: files are attached, while folders provide their paths only.',
  'file.directoryClose': 'Close file browser',
  'file.directorySelected': '{count} item(s) selected',
  'file.directoryCancel': 'Cancel',
  'file.directoryAdd': 'Add selected items',
  'file.directoryLoading': 'Adding…',
  'file.attachedGroup': 'Attached files',
  'file.unnamed': 'Unnamed file',
  'file.unsupportedType': 'Only images, TXT, Markdown, JSON, and YAML files are supported',
  'file.unsupportedFile': 'Unsupported type',
  'file.contextFile': 'File',
  'file.contextFolder': 'Folder',
  'file.removeFolder': 'Remove folder {name}',
